...
paragrafo.innerHTML = `você sabia que o mundo tem <span> ${dados.total_pessoas_mundo} </pan> de pessoas 
e que aproximadamente <span> ${dados.total_pessoas_conectadas} </span> estão conectadas em alguma rede ocial e passam em média ${dados.tempo_medio}
horas conectada.`
